...
void ContainerLoadWidgets() {
	...
	widgets.push_back(new Stage());
	widgets.push_back(new Throttle());
	widgets.push_back(new SevenSegment());
	...
	widgets.push_back(new GaugeAltimeter());
	widgets.push_back(new GaugeFuelStrip());
