...
#define MC_SAS		(1 << 0)	// 00000001
#define MC_RCS		(1 << 1)	// 00000010
#define MC_LIGHTS	(1 << 2)	// 00000100
#define MC_GEAR		(1 << 3)    // 00001000
#define MC_BRAKES	(1 << 4)	// 00010000
#define MC_ABORT	(1 << 5)	// 00100000
#define MC_STAGE	(1 << 6)	// 01000000

//Action group flags
#define AG_1 (1 << 0)			// 00000000 00000001
#define AG_2 (1 << 1)			// 00000000 00000010
#define AG_3 (1 << 2)			// 00000000 00000100
#define AG_4 (1 << 3)			// 00000000 00001000
#define AG_5 (1 << 4)			// 00000000 00010000
#define AG_6 (1 << 5)			// 00000000 00100000
#define AG_7 (1 << 6)			// 00000000 01000000
#define AG_8 (1 << 7)			// 00000000 10000000
#define AG_9 (1 << 8)			// 00000001 00000000
#define AG_10 (1 << 9)			// 00000010 00000000
